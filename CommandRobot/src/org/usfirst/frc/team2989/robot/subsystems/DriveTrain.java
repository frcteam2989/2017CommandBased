...
public class DriveTrain extends Subsystem {
	...
	public static RobotDrive robotDrive = new RobotDrive(RobotMap.MOTOR_LEFT_FRONT, RobotMap.MOTOR_RIGHT_FRONT, RobotMap.MOTOR_LEFT_REAR, RobotMap.MOTOR_RIGHT_REAR);
